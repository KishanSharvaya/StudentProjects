...
class _InquiryProductListScreenState extends BaseState<InquiryProductListScreen>
  ...
  Widget buildBody(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          AppBar(title: Text("Product List")),
    ...
    return Container(
        ...
        child: ExpansionTileCard(
          ...
          leading: CircleAvatar(
              ...
              child: Icon(Icons
                  .pages)), //Image.network("https://cdn-icons.flaticon.com/png/512/4785/premium/4785452.png?token=exp=1639741267~hmac=4fc9726eef0cf39128308a40039ea5ca", height: 35, fit: BoxFit.fill,width: 35,)),
          title: Text(
            model.ProductName,
